...
![Mean SBP at six months by treatment, y-axis starting at 132 mmHg. Placebo looks nearly four times the height of ACEi; the actual difference is about 11 mmHg.](../figures/dataviz/03-truncated-wrong.png){#fig-truncated fig-alt="A bar chart of mean six-month systolic by treatment with the y-axis starting at 132 mmHg, exaggerating a roughly 11 mmHg difference into an almost fourfold apparent gap."}
...
![A dot plot of the same percentages: ACEi highest at 47%, then ARB (40%) and CCB (34%), with Placebo lowest at 15%. The visual ranking matches the numerical one.](../figures/dataviz/04-dotplot-good.png){#fig-dotplot fig-alt="A dot plot of the same four proportions on one axis: ACEi highest at 47 percent, then ARB 40, CCB 34, and Placebo lowest at 15; the ranking is immediately clear."}
