...
![DBP at baseline by treatment arm: FMUP theme (left) and Pequod theme (right). Same data, same geometry, different visual register.](../figures/dataviz/theme-comparison.png){#fig-theme-comparison fig-alt="The same layered distribution plot rendered twice side by side: left on a white FMUP theme, right on a warm Pequod paper background, with identical geometry and data."}
