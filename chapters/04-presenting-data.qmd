...
A worked example of why the format choice matters. The same finding (*"participants were mostly male, 2,829 (54%)"*) plotted as a pie chart and a bar chart:
...
|------------------------------|----------------------|---------|
| NT-proBNP (per log-unit)     | 1.31 (1.08--1.59)    | 0.005   |
| Age (per 10 years)           | 1.14 (1.02--1.28)    | 0.02    |
| Male sex (vs female)         | 1.09 (0.88--1.35)    | 0.43    |
| LVEF (per 5%)               | 0.92 (0.85--0.99)    | 0.03    |
| NYHA III--IV (vs I--II)      | 1.67 (1.31--2.13)    | <0.001  |
...
![**Bad.** A truncated y-axis turns a ~15% true difference (1,000 vs 1,150 pg/mL, clinically modest) into what looks like a 4-fold effect. The same numbers on a zero-anchored axis would look unremarkable.](../figures/sw/03-bad-truncated.png){#fig-bad-trunc fig-alt="A bar chart whose y-axis does not start at zero, exaggerating a roughly 15 percent difference into an apparent several-fold gap."}
