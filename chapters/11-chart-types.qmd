...
palette = ["#16222a", "#0b62cf", "#D55E00", "#009E73"]

fig, ax = plt.subplots(figsize=(6.4, 4))
sns.violinplot(data=cohort, x="treatment", y="dbp_baseline",
               palette=palette, fill=False, linewidth=0.6, ax=ax)
sns.stripplot(data=cohort, x="treatment", y="dbp_baseline",
              palette=palette, alpha=0.30, jitter=0.16, size=3, ax=ax)
sns.boxplot(data=cohort, x="treatment", y="dbp_baseline",
            palette=palette, showfliers=False, fill=False,
            width=0.18, ax=ax)
