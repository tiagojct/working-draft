...
sns.histplot(data=cohort, x="sbp_baseline", binwidth=5,
             stat="density", color="#FFCD00", alpha=0.75,
             edgecolor="white", ax=ax)
sns.kdeplot(data=cohort, x="sbp_baseline",
            color="#1A1A1A", linewidth=2, ax=ax)
...
palette = ["#1A1A1A", "#2B7BB9", "#D06B3A", "#3A9653"]
...
sns.regplot(data=cohort, x="sbp_baseline", y="dbp_baseline",
            scatter_kws=dict(alpha=0.30, color="#2B7BB9", s=14),
            line_kws=dict(color="#1A1A1A", linewidth=2),
            ax=ax)
